...
| Status | What happens                                                                                                    |
| ------ | --------------------------------------------------------------------------------------------------------------- |
| 401    | `refreshOnUnauthenticated` called once → `bearerToken` re-read → request retried → if refresh fails, the request rejects with `core:auth/refresh-failed` on the `error` channel |
