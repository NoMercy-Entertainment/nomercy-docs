...
- [Media Tracks](/nomercy-player-core/media-tracks): `qualityLevels()` and `quality()`
- [Player State](/nomercy-player-core/player-state): `qualityMode()` for the ABR/MANUAL mode flag
