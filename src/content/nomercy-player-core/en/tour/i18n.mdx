...
{/* Source: packages/nomercy-player-core/src/adapters/translator/translator.ts, src/core/mixins/i18n.ts, src/core/title-tokens.ts */}

# Core: i18n

Translation is a swappable adapter like storage or the platform bundle, with a working default: `DefaultTranslator`, seeded with English and Dutch, ready before a single plugin registers.
