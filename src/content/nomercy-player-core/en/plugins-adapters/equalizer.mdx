...
Register it when you want to give listeners tone control: a preset picker, a band-by-band panel, or a single stored curve that follows them between sessions.
