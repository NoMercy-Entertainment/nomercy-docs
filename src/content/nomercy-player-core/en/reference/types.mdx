...
| Type | Shape |
|---|---|
| `TimeState` | `{ position, duration, buffered, remaining, percentage }` — seconds except `percentage` (0-100). Returned by `timeData()`. |
