...
::code-group {{ title: 'Request', tag: 'GET', label: '/v1/attachments' }}
...
::code-group {{ title: 'Request', tag: 'POST', label: '/v1/attachments' }}
...
::code-group {{ title: 'Request', tag: 'GET', label: '/v1/attachments/Nc6yKKMpcxiiFxp6' }}
...
::code-group {{ title: 'Request', tag: 'PUT', label: '/v1/attachments/Nc6yKKMpcxiiFxp6' }}
...
::code-group {{ title: 'Request', tag: 'DELETE', label: '/v1/attachments/Nc6yKKMpcxiiFxp6' }}
