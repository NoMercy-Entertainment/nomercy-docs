...
import type { NMVideoPlayer, VideoPlaylistItem } from '@nomercy-entertainment/nomercy-video-player@beta';
...
```ts
import { KeyHandlerPlugin } from '@nomercy-entertainment/nomercy-video-player@beta';
