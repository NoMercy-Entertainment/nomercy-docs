...
- [Advanced: Custom Plugin](/player/advanced/custom-plugin) — watch-party-lite plugin for same-device sync
- [Advanced: Multi-Instance](/player/advanced/multi-instance) — multiple players on one page
- [Kit — Auth & Fetch](/player/kit/auth-fetch) — securing WebSocket connections with bearer tokens
