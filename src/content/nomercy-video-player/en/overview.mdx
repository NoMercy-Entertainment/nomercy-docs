...
- **Methods** are how you tell it what to do: `play()`, `pause()`, `volume(0.5)`, `time(t)` to seek, `next()`.
- **Events** are how it tells you what happened: `time`, `play`, `pause`, `current`, `qualitychanged`, and the rest of a fully typed event map.
