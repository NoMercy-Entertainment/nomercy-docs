...
| [`TvKeyHandlerPlugin`](/nomercy-video-player/plugins/tv-key-handler) | `'tv-key-handler'` | TV remote bindings (Color buttons, Info OSD, MediaRecord bookmark, TV-aware Arrow seek and volume); subclasses `KeyHandlerPlugin` |
