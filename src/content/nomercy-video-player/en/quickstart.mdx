...
- [Build your own UI](/nomercy-video-player/guides/build-ui-overview) — replace `DesktopUiPlugin` with your own controls, step by step.
- [DesktopUiPlugin](/nomercy-video-player/plugins/desktop-ui) — configure the built-in UI instead.
- [Configuration](/nomercy-video-player/configuration) — every `setup()` option and its default.
- [API Methods](/nomercy-video-player/api-methods) — the full method surface on the player.
