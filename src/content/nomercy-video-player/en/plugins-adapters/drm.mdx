...
```ts
import { DrmPlugin } from '@nomercy-entertainment/nomercy-video-player';
...
- [Plugin: Live Transcoding](/nomercy-video-player/plugins-adapters/live-transcoding): another server-coordination plugin, gating playback on a WebSocket signal instead of a license server.
