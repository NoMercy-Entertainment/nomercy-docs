...
description: 'IThumbnailSource: load(item), lookup(time), unload(). Sprite-sheet scrub-preview lookup, standalone like Chapter Source, not the same loader DesktopUiPlugin uses internally.'
---
