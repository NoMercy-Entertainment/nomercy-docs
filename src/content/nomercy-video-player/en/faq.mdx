...
No. `hls.js` installs automatically with the player (a direct dependency of the player package) — nothing extra to install for the npm / bundler path. See [Installation](/nomercy-video-player/installation) for the CDN exception.
