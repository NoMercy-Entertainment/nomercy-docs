...
No. hls.js ships as a regular dependency of `@nomercy-entertainment/nomercy-video-player`.
Your bundler will include it automatically.
...
Yes. The player is headless and framework-agnostic.
