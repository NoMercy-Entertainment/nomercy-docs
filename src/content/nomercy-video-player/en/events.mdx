...
- [Kit Events Reference](/nomercy-player-core/events-reference) — full `BaseEventMap` coverage including queue, auth, phase, and plugin events inherited by all players
