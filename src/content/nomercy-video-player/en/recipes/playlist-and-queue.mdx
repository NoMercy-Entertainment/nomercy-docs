...
- [Recipes: Crossfade and Gapless](/nomercy-player-kit/queue) — smooth transitions between queue items
- [Recipes: Persistence](/nomercy-player-kit/storage) — save and restore queue position across page loads
- [Music — API Methods](/nomercy-player-kit/queue) — full queue method reference
