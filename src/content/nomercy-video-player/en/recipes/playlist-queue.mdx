...
{/* Source: packages/player-web/nomercy-player-core/src/core/mixins/queue.ts, packages/player-web/nomercy-video-player/src/types.ts */}
...
- [Recipe: Auth Tokens via baseUrl + auth](/nomercy-video-player/recipes/auth-tokens): protecting the same catalog this panel lists behind a bearer token.
