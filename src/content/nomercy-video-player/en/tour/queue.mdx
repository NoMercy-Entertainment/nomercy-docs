...
player.setup({
  ...
  playlist: [
    { id: 'sintel', title: 'Sintel', file: '/Sintel.(2010)/Sintel.(2010).NoMercy.m3u8' },
    { id: 'big-buck-bunny', title: 'Big Buck Bunny', file: '/Big.Buck.Bunny.(2008)/Big.Buck.Bunny.(2008).NoMercy.m3u8' },
  ],
});
```
...
The player below mounts with a real three-item queue over one shared `baseUrl`.

:::snippet{file="video-tour-queue" live="false"}
:::
