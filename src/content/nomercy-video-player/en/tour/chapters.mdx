...
Once the duration is known, any span the list fails to cover is backfilled: a lead-in before the first chapter, a hole between two, or a tail after the last.
