...
Two clients playing the same HLS stream independently will drift apart.
Sources of drift:
...
System clocks differ between clients.
Measure the offset before using server timestamps:
...
- [Advanced: Multi-Instance](/nomercy-player-core/advanced/multi-instance), multiple players on one page
- [Core: Auth and Fetch](/nomercy-player-core/auth-fetch), securing WebSocket connections with bearer tokens
