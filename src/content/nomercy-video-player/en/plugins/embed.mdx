...
{/* Source: packages/nomercy-player-kit/src/plugins/embed/index.ts; re-exported from @nomercy-entertainment/nomercy-player-core via the video player's plugins barrel */}
