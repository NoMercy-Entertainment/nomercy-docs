...
{/* Source: packages/nomercy-player-kit/src/plugins/tab-leader/index.ts; re-exported from @nomercy-entertainment/nomercy-player-core via the video player's plugins barrel */}
...
- [Player Core plugins](/nomercy-player-core/plugins)
