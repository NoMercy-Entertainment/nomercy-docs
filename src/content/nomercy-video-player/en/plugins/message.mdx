...
{/* Source: packages/nomercy-player-kit/src/plugins/message/index.ts; re-exported from @nomercy-entertainment/nomercy-player-core via the video player's plugins barrel */}
