...
{/* Source: docs/nomercy-docs/src/examples/video-build-3-progress-bar.ts, packages/player-web/nomercy-player-core/src/types/player.ts */}
...
:::snippet{file="video-build-3-progress-bar"}
:::
