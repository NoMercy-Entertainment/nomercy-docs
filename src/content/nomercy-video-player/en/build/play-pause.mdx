...
{/* Source: docs/nomercy-docs/src/examples/video-build-2-play-pause.ts, packages/player-web/nomercy-player-core/src/core/mixins/container-class-emit.ts */}
...
:::snippet{file="video-build-2-play-pause"}
:::
