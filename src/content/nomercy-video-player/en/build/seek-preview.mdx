...
{/* Source: docs/nomercy-examples/src/components/TutorialPlayer/steps/step9Plugin.ts, packages/nomercy-player-core/src/core/plugin/base.ts, packages/nomercy-player-core/src/types/chapter.ts */}
...
Hover along the scrubber: Sintel's real sprite thumbnails follow the pointer, the chapter line flips from "Opening" through "A Dangerous Quest" to "End Credits" as you cross the ticks, and the timestamp sits underneath.
