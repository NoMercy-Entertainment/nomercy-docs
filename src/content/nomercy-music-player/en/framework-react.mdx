...
<TrackTitle
  ...
  artist={currentTrack?.artistTracks?.[0]?.name}
/>
```
...
const DEMO_PLAYLIST: MusicPlaylistItem[] = [
  {
    id: 'sintel-score-1',
    name: 'Sintel Theme',
    artistTracks: [{ id: 'jan-morgenstern', name: 'Jan Morgenstern' }],
    albumTracks: [{ id: 'sintel-ost', name: 'Sintel OST' }],
  ...
  },
  {
    ...
    artistTracks: [{ id: 'jan-morgenstern', name: 'Jan Morgenstern' }],
    albumTracks: [{ id: 'bbb-ost', name: 'Big Buck Bunny OST' }],
...
export const TrackInfo = memo(function TrackInfo() {
  ...
  return (
    <div className="track-info">
      ...
      <p className="track-artist">{currentTrack?.artistTracks?.[0]?.name ?? ''}</p>
    </div>
  );
});
```
    ...
    <div className="progress-bar">
      ...
      <div
        ...
        onClick={(event) => {
          const bar = event.currentTarget;
          const ratio = event.nativeEvent.offsetX / bar.clientWidth;
          void player.currentTime(ratio * duration);
        }}
      >
