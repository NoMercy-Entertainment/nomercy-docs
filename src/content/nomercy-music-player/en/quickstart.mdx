...
- [Build a music UI](/nomercy-music-player/plugins/music-ui) — drive your own interface from player events.
- [Configuration](/nomercy-music-player/configuration) — every `setup()` option and its default.
- [API Methods](/nomercy-music-player/api-methods) — the full method surface on the player.
- [Recipes](/nomercy-music-player/recipes/overview) — crossfade, gapless, lyrics, and queue patterns.
