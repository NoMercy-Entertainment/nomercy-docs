...
For the general plugin authoring guide (lifecycle, `this.on`, `this.emit`, `this.fetch`, `this.logger`), see [Writing Plugins](/nomercy-player-kit/writing-plugins) in the player kit docs.
...
- [Player Kit — Writing Plugins](/nomercy-player-kit/writing-plugins) — full plugin authoring guide (lifecycle, helpers, i18n)
