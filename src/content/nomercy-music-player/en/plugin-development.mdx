...
For the full plugin authoring guide including lifecycle, helpers, i18n, and the plugin contract, see [Writing Plugins](/nomercy-player-core/plugin-authoring) in the player core docs.
...
- [Player Core, Writing Plugins](/nomercy-player-core/plugin-authoring), complete plugin lifecycle reference
