...
description: 'Music keyboard handler that adds track navigation, repeat cycling, and shuffle toggle on top of the kit playback defaults.'
draft: false
---
...
Every music player benefits from keyboard shortcuts, and most of the plumbing already lives in the kit.
...
Hardware media keys (`MediaPlay`, `MediaPause`, `MediaPlayPause`, `MediaStop`, `MediaRewind`, `MediaFastForward`, `MediaTrackNext`, `MediaTrackPrevious`) are also installed by the kit and fire from physical media keys, Bluetooth headphone controls, and most TV remotes.
