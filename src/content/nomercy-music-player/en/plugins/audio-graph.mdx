...
description: 'Web Audio API signal chain owner, prerequisite for EqualizerPlugin and every custom audio processing plugin.'
draft: false
---
...
Removes a previously inserted effect node and triggers a chain rebuild.
Safe to call with a node that was never inserted.
...
All connections registered here are disconnected on dispose.
