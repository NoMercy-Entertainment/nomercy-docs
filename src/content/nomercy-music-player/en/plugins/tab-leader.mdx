...
- [Player Core, TabLeaderPlugin](/nomercy-player-core/plugins-builtin), full player core plugin documentation
- [Plugin registration](/nomercy-player-core/plugin-registration), how `addPlugin` and `getPlugin` work
- [Event system](/nomercy-player-core/event-system), namespaced plugin events
