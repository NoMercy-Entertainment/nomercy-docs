...
For the full method reference see [Crossfade Methods](/nomercy-music-player/api/crossfade).
...
If `EqualizerPlugin` and `AudioGraphPlugin` are registered, the EQ graph applies to both audio paths during a crossfade.
