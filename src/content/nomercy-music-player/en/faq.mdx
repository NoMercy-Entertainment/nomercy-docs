...
2. **Manual:** Call `player.crossfadeTo(track, { duration: 3 })` from your own code. A manual crossfade always ramps linearly; the `curve` option shapes only the automatic AutoAdvance transition.
