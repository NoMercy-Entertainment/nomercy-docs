...
The music player separates playback transport into swappable backends, each implementing `IAudioBackend`.
Two are built in, and you can inject your own via `backendFactory`.
