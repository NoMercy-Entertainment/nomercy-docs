...
```ts
import type { IPlaylistGenerator } from '@nomercy-entertainment/nomercy-music-player';
```
...
```ts
import { LinearPlaylistGenerator } from '@nomercy-entertainment/nomercy-music-player';
```
...
```ts
import { SmartShuffleGenerator } from '@nomercy-entertainment/nomercy-music-player';
```
