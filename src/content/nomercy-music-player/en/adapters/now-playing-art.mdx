...
- [MediaSessionPlugin](/nomercy-music-player/plugins/media-session): does its own Media Session metadata/artwork push (this adapter is a standalone alternative, not used internally)
