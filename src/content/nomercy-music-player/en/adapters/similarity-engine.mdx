...
Port for "find tracks similar to this one." It powers radio mode, "more like this" playlist generation, and the [`SmartShuffleGenerator`](/nomercy-music-player/adapters/playlist-generator) when tag-based similarity is not enough.
...
- [Playlist Generator](/nomercy-music-player/adapters/playlist-generator): `SmartShuffleGenerator` delegates to a similarity engine when tags alone fall short
