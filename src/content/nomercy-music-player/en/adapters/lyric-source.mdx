...
```ts
import type { ILyricSource } from '@nomercy-entertainment/nomercy-music-player';
```
...
```ts
import { LrcFileSource } from '@nomercy-entertainment/nomercy-music-player';
```
...
```ts
import type { ILyricSource, MusicPlaylistItem } from '@nomercy-entertainment/nomercy-music-player';
