...
import type { MusicPlaylistItem, MusicPlayerConfig, IMusicPlayer } from '@nomercy-entertainment/nomercy-music-player';

// Plugins — always import from the /plugins subpath
import { AutoAdvancePlugin, LyricsPlugin, MediaSessionPlugin } from '@nomercy-entertainment/nomercy-music-player/plugins';
```
