...
**Prerequisites:** [Kit — Adapters](/player/kit/adapters) for the port catalog. [Kit — Testing](/player/kit/testing) for the test harness.
...
- [Kit — Adapters](/player/kit/adapters) — full port catalog with all 28 interfaces
- [Kit — Testing](/player/kit/testing) — `describePlugin`, `assertNoListenerLeak`, and the full test harness
- [Advanced: Custom Plugin](/player/advanced/custom-plugin) — writing a plugin that uses your custom adapter
