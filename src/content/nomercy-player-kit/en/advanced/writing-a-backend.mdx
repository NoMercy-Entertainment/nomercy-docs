...
Read this when you need to support a streaming protocol or media pipeline not covered by the built-in backends, such as MPEG-DASH, smooth streaming, or a custom MSE pipeline.
