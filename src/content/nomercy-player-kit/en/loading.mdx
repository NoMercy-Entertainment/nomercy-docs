...
await player.load(
  { id: 'cosmos', url: 'https://raw.githubusercontent.com/NoMercy-Entertainment/nomercy-media/master/Films/Tears.of.Steel.(2012)/Tears.of.Steel.(2012).NoMercy.m3u8' },
...
- [Media Tracks](/player/kit/media-tracks) — `subtitles()`, `chapters()`, `currentSubtitle()`
- [Transport](/player/kit/transport) — `play()`, `stop()`
- [Events Reference](/player/kit/events-reference) — `beforeLoad`, `mediaReady`, `playlistReady`
