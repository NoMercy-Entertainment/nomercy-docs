...
- [setup(), ready(), setupState()](/nomercy-player-core/setup)
- [Phase API, phase() transitions](/nomercy-player-core/phase)
- [Events Reference, dispose event](/nomercy-player-core/events-reference)
