...
- [setup()](/nomercy-player-kit/setup) — `setup()`, `ready()`, `setupState()`
- [Phase API](/nomercy-player-kit/phase) — `phase()` transitions
- [Events Reference](/nomercy-player-kit/events-reference) — `dispose` event
