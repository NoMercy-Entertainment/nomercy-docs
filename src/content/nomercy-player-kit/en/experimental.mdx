...
- [Events Reference](/player/kit/events-reference) — `beforePlay`, `beforeSeek`, and other cancellable events (prefer these over `override`)
- [Mutation Guards](/player/kit/mutation-guards) — `beforeMutation` advisory system
