...
- [Volume](/player/kit/volume) — `volume()`, `mute()`, `unmute()`
- [Transport](/player/kit/transport) — `play()`, `pause()`, `stop()`, `next()`
- [Events Reference](/player/kit/events-reference) — `repeat`, `shuffle`, `play`, `pause`
