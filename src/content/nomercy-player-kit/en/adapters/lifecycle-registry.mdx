...
The kit creates a fresh `LifecycleRegistry` for each plugin instance and hands it to the plugin as `this.lifecycle`.
...
- [Event Bus](/nomercy-player-kit/adapters/event-bus), the other core internal both players and plugins share
