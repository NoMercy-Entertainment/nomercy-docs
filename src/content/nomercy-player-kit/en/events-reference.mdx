...
- [BeforeEvent contract](/nomercy-player-core/types/interfaces): `preventDefault`, `delay`, `stopImmediatePropagation`
- [Transport](/nomercy-player-core/transport): `play`, `pause`, `stop`, `next`, `previous`
- [Mutation Guards](/nomercy-player-core/mutation-guards): `beforeMutation`, `mutationPrevented`
