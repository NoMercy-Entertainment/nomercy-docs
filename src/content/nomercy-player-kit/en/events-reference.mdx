...
- [BeforeEvent contract](/player/kit/types/interfaces) — `preventDefault`, `delay`, `stopImmediatePropagation`
- [Transport](/player/kit/transport) — `play`, `pause`, `stop`, `next`, `previous`
- [Mutation Guards](/player/kit/mutation-guards) — `beforeMutation`, `mutationPrevented`
