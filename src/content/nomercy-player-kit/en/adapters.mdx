...
The kit gives you 28 of these ports, all listed below. Libraries built on the kit add ports of their own, documented with whichever library owns them.
...
| Subtitle renderer   | (internal) | `ISubtitleRenderer`  | DOM text overlay  | You want styled, positioned subtitle rendering instead of plain DOM text |
...
| DRM config       | `drm`      | `IDrmConfig`       | None                         | Your content is DRM-protected                                  |
