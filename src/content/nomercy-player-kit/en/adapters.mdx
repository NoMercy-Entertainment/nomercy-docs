...
The video and music players each add their own ports on top of these, like the video backend or the lyric source. Those live with their libraries, not here: see [Video configuration](/nomercy-video-player/configuration) and [Music configuration](/nomercy-music-player/configuration).
