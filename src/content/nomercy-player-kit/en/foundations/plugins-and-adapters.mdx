...
If you catch yourself wanting an existing job *done differently*, you want an adapter. See [Adapters](/nomercy-player-core/adapters) for all 28 ports and how to wire them.
