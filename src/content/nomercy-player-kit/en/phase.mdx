...
- [setup()](/nomercy-player-kit/setup) — pipeline stages and `ready()`
- [Player State](/nomercy-player-kit/player-state) — `bufferState`, `networkState`, `visibilityState`
- [Events Reference](/nomercy-player-kit/events-reference) — `phase` event
