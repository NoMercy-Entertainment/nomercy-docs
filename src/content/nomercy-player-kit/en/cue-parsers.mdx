...
- [Media Tracks](/nomercy-player-kit/media-tracks) — `currentSubtitle`, sidecar VTT handling
- [Events Reference](/nomercy-player-kit/events-reference) — `cue:enter`, `cue:exit`, `subtitleCue`
