...
**Prerequisites:** The auth config is the same on video and music players. For the full reference see [Kit — Auth & Fetch](/player/kit/auth-fetch).
...
- [Kit — Auth & Fetch](/player/kit/auth-fetch) — full `AuthConfig` interface reference
- [Advanced: Custom Adapter](/player/advanced/custom-adapter) — writing a fully custom auth adapter for non-standard signing schemes
- [Recipes: Persistence](/player/recipes/persistence) — auth tokens + watch position working together
