...
Go back to the previous queue item and start playback.
Silently no-ops when no previous item exists, as going past the start is a common gesture, not an error.
...
- [Seeking](/nomercy-player-core/seeking): `currentTime`, `rewind`, `forward`, `seekByPercentage`
- [Events Reference](/nomercy-player-core/events-reference): `beforePlay`, `play`, `beforeSeek`, `seek`
- [Queue Navigation](/nomercy-player-core/queue-navigation): `next`, `previous`, `current`
