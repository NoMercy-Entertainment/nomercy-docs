...
See [Video — Subtitle Overlay](/nomercy-video-player/subtitle-overlay) for the full API.
...
HDR-aware ABR is automatic — on SDR displays, the player filters out HDR levels from the ABR selection pool. No configuration needed. See [Video — HLS](/nomercy-video-player/hls) for the full quality API.
