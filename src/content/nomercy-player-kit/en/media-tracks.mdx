...
- [Loading](/player/kit/loading) — `resolveItemTrackUrls`, sidecar track resolution
- [Chapters](/player/kit/chapters) — full chapter API reference
- [Events Reference](/player/kit/events-reference) — `subtitle`, `subtitleCue`, `audioTrack`, `chapters`
