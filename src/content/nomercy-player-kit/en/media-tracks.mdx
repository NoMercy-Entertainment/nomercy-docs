...
Chapters for the active playlist item. Returns `[]` until the async chapter fetch settles — subscribe to the `chapters` event for the ready signal.
...
- [Loading](/nomercy-player-kit/loading) — `resolveItemTrackUrls`, sidecar track resolution
- [Chapters](/nomercy-player-kit/chapters) — full chapter API reference
- [Events Reference](/nomercy-player-kit/events-reference) — `subtitle`, `subtitleCue`, `audioTrack`, `chapters`
