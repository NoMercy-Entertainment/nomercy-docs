...
- [Plugin Registration](/player/kit/plugin-registration) — `addPlugin`, `removePlugin`, `getPlugin`
- [Built-in Plugins](/player/kit/plugins-builtin) — plugins shipped with the kit
- [Key Interfaces](/player/kit/types/interfaces) — `IPlayer`, `BasePlayerConfig`, `BaseEventMap`
- [Storage Adapter](/player/kit/storage) — `IStorage` and backend implementations
