...
The table below shows the top-level groups. For the full per-event payload reference see [Events Reference](/player/kit/events-reference).
...
- [Runtime Classes](/player/kit/types/classes) — `Plugin`, `Logger`, `LifecycleRegistry`
- [Enums](/player/kit/types/enums) — `SetupState`, `BufferState`, `CastState`, and more
- [Error Classes](/player/kit/types/errors) — `PlayerError` and subclasses
- [Events Reference](/player/kit/events-reference) — full event payload table
- [Setup](/player/kit/setup) — `BasePlayerConfig` in context
