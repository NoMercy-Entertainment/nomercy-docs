...
Shipped inside the video or music player packages. These are domain-specific to their media type, and each library documents its own. See the [Video Player](/nomercy-video-player) and [Music Player](/nomercy-music-player) sections for their plugin pages.
