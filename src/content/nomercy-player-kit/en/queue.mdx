...
```ts
player.queueAppend({ id: 'cosmos', title: 'Cosmos Laundromat' });
...
- [Queue Navigation](/player/kit/queue-navigation) — `current`, `next`, `previous`, `seekToIndex`
- [Backlog](/player/kit/backlog) — `backlog`, `backlogAppend`
- [BasePlaylistItem](/player/kit/playlist-item) — item shape
- [Events Reference](/player/kit/events-reference) — `queue`, `queue:append`, `queue:exhausted`
