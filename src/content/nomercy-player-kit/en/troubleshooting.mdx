...
**Fix:** Install the optional peer (when available on the npm registry — currently the package ships from NoMercy's own registry; check the [Octopus plugin docs](/nomercy-video-player/subtitle-overlay) for current installation steps):
