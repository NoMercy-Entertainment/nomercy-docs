...
- [Plugin Registration](/player/kit/plugin-registration) — `addPlugin`, `static advisories`
- [Events Reference](/player/kit/events-reference) — `beforeMutation`, `mutationPrevented`
