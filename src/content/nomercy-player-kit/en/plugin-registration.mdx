...
- [Built-in Kit Plugins](/player/kit/plugins-builtin) — shipped plugins
- [Events Reference](/player/kit/events-reference) — `plugin:installed`, `plugin:failed`, `plugin:disposed`
