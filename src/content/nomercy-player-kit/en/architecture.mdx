...
| -------------------------------------------------- | ------------------------------ | ---------------------------------------------------------------------------- |
| `@nomercy-entertainment/nomercy-player-core@rc`  | 2 (core) + 4 (built-in plugins) | Library authors, advanced consumers writing plugins directly against the core |
| `@nomercy-entertainment/nomercy-video-player@rc` | 3 + 4                          | Anyone building a video player                                               |
| `@nomercy-entertainment/nomercy-music-player@rc` | 3 + 4                          | Anyone building a music player                                               |
