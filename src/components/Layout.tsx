    ...
    <MotionConfig reducedMotion="user">
      <SectionProvider sections={sections}>
        <div className="h-full lg:ml-72 xl:ml-80">
          <motion.div
            layoutScroll
            className="contents lg:pointer-events-none lg:fixed lg:inset-x-0 lg:top-14 lg:bottom-0 lg:z-40 lg:flex"
          >
            {/* The column starts under the bar and owns only the page list.
                `contents` keeps both wrappers out of the way on mobile, where
                the sidebar is a drawer instead. */}
            <div className="contents lg:pointer-events-auto lg:flex lg:h-full lg:w-72 lg:flex-col lg:border-r lg:border-zinc-900/10 xl:w-80 lg:dark:border-white/10">
              ...
              {/* Navigation.tsx centres the active link by scrolling
                  ...
                  scrolling up under the bar dissolves instead of being cut in
                  half at a hard edge. Nothing sits in the fade at rest — the
                  nav's own top margin clears it. */}
              <div
                data-sidebar-scroll
              ...
              >
                <Navigation className="hidden lg:mt-3 lg:block" navigation={navigation} apiGroups={apiGroups} initialPathname={initialPathname} />
              </div>
            </div>
          </motion.div>
          <div className="relative flex h-full flex-col px-4 pt-14 sm:px-6 lg:px-8">
