  ...
  useEffect(() => {
    ...
    preElements.forEach((preElement) => {
      ...
      if (!isWrapped) {
        ...
        copyButton.className = 'group/button absolute top-3.5 right-4 overflow-hidden rounded-full py-1 pl-2 pr-3 text-2xs font-medium opacity-0 backdrop-blur transition focus:opacity-100 group-hover:opacity-100 bg-zinc-900/5 hover:bg-zinc-900/10 dark:bg-white/5 dark:hover:bg-white/10';
