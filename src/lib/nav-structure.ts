...
export const navStructure: Record<string, NavGroupDef[]> = {
  ...
  'nomercy-player-kit': [
    ...
    { group: "Adapter Ports", pages: ['adapters', 'storage', 'streams', 'cue-parsers', 'preload-transition', 'platform'] },
  ...
  'nomercy-video-player': [
    ...
    { group: "Plugins", pages: ['plugins/auto-advance', 'plugins/desktop-ui', 'plugins/subtitle-overlay', 'plugins/octopus', 'plugins/touch-zones', 'plugins/key-handler', 'plugins/skipper', 'plugins/drm', 'plugins/live-transcoding', 'plugins/cast-sender', 'plugins/media-session', 'plugins/tv-ui', 'plugins/tab-leader', 'plugins/message', 'plugins/embed', 'plugins/audio-graph'] },
    { group: "Types Reference", pages: ['types'] },
    { group: "Configuration", pages: ['configuration'] },
    { group: "API Methods", pages: ['api-methods', 'api/factory', 'api/playback-state', 'api/aspect-ratio', 'api/cycling', 'api/backend', 'api/kit-methods'] },
    { group: "Events", pages: ['events'] },
    { group: "Playlist Item", pages: ['playlist-item'] },
    { group: "HLS", pages: ['hls'] },
    ...
    { group: "Troubleshooting", pages: ['troubleshooting'] },
    { group: "Advanced", pages: ['advanced/server-side-rendering', 'advanced/custom-adapter', 'advanced/embedding', 'advanced/distributed-playback', 'advanced/performance', 'advanced/migration-from-other-players'] },
    { group: "Reference", pages: ['faq'] },
    { group: "Migration", pages: ['migration-v1-v2'] },
  ],
  'nomercy-music-player': [
    { group: "Getting Started", pages: ['overview', 'installation', 'quickstart'] },
    { group: "Plugins", pages: ['plugins/auto-advance', 'plugins/lyrics', 'plugins/cast-sender', 'plugins/media-session', 'plugins/key-handler', 'plugins/music-ui', 'plugins/tab-leader', 'plugins/group-listening', 'plugins/drm', 'plugins/live-transcoding', 'plugins/embed', 'plugins/message', 'plugins/audio-graph', 'lyrics', 'equalizer'] },
    { group: "Types Reference", pages: ['types'] },
    { group: "Configuration", pages: ['configuration'] },
    { group: "API Methods", pages: ['api-methods', 'api/factory', 'api/backend', 'api/crossfade', 'api/kit-methods', 'crossfade'] },
    { group: "Events", pages: ['events'] },
    { group: "Playlist Item", pages: ['playlist-item'] },
    { group: "Framework Integration", pages: ['framework-vue', 'framework-react'] },
    { group: "Writing Plugins", pages: ['plugin-development'] },
