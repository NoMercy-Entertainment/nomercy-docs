...
Before you can make requests to the Protocol API, you will need to grab your API key from your dashboard. You find it under [Settings &raquo; API](#).
...
::code-group {{ tag: 'GET', label: '/v1/conversations' }}
...
::button {{ url: '/conversations', variant: 'text' }}
