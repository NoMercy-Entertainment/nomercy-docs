...
::code-group {{ title: 'Request', tag: 'GET', label: '/v1/groups' }}
...
::code-group {{ title: 'Request', tag: 'POST', label: '/v1/groups' }}
...
::code-group {{ title: 'Request', tag: 'GET', label: '/v1/groups/L7cGNIBKZiNJ6wqF' }}
...
::code-group {{ title: 'Request', tag: 'PUT', label: '/v1/groups/L7cGNIBKZiNJ6wqF' }}
...
::code-group {{ title: 'Request', tag: 'DELETE', label: '/v1/groups/L7cGNIBKZiNJ6wqF' }}
